...
final class Store: ObservableObject {
    ...
    private let fileName = "sunscreentimer_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Application One", detail: "First example entry.", date: now),
            Entry(title: "Sample Application Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Application Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
